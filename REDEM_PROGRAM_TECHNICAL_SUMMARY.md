...
| **Venue / status** | **PRX Intelligence → desk-rejected (2026-09): scope mismatch** → *Applied Intelligence* (`PAPER_D_AI.tex`, kept for rollback) → current submission version **`PAPER_D_NC.tex` / `.pdf` (31 pp, elsarticle) for *Neurocomputing*** (`paper_d/README.md:13-21`). Zenodo `10.5281/zenodo.22110623`. |
