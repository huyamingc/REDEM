...
- **Tab 2** (from `data/s9_baseline_showdown_v1.csv/json`): REDEM 0.991 vs GRU-frozen 0.371 (pre 0.923 → post 0.070) vs transformer-frozen 0.351 (pre 1.000 → post 0.000) vs ESN-online 0.998. MG NMSE: REDEM 0.0018 vs ESN 0.0002 vs GRU 1.30 vs transformer 1.07.
...
- **Fig 3 / Tab 5** (from `data/s5_dual_timescale_v1.csv/json`): regime task — dual vs fast-only +1.3 pp (parallel, t=19.6, p<0.0001) / +2.1 pp (near-edge, t=20.2); adaptation 9–20× faster (3–12 vs 66–105 pulses); slow-only ≈ dual (statistics-dominated task).
...
- Showdown: REDEM 0.991 / ESN 0.998 / GRU 0.371 / trans 0.351 (drift); MG NMSE REDEM 0.0018 / ESN 0.0002 / GRU 1.30 / trans 1.07.
...
- Metadata: +1.3–2.1 pp (p<0.0001), adaptation 9–20× faster.
